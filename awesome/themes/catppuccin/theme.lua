...
local themes_path = "/home/tofu/.config/awesome/themes/"

local theme = {}

theme.font          = "Terminess Nerd Font Mono"

-- Define colours (Catppuccin Macchiato)
...
theme.bg_minimize   = theme.surface0
theme.bg_systray    = theme.bg_normal

theme.fg_normal     = theme.text
theme.fg_focus      = theme.blue
theme.fg_urgent     = theme.base
...
theme.wallpaper = themes_path.."catppuccin/duck_wallpaper.png"
